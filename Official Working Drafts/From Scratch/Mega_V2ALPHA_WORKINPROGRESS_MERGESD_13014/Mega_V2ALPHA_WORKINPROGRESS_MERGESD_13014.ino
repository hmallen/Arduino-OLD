/*
 ...
 - Fix SD write so regular write also occurs during aggregation event
...
void setup() {
  ...
  //amtCons = 0;  // Reset amount consumed that was calculated in gprsBootLoop()
  //amtConsTot = 0;  // Reset aggregate amount consumed that was modified after gprsBootLoop()
