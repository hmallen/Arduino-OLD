...
void calibAnalogSensors() {
  ...
  h2oCalibMin = analogRead(h2oPin);
  foodCalibMin = analogRead(foodPin);
  ...
  h2oCalibMax = analogRead(h2oPin);
  foodCalibMax = analogRead(foodPin);
  Serial.println(F("Release the button to continue."));
  ...
  if(h2oCalibMin > 255) {
    int h2oMinRemain = h2oCalibMin % 255;
  }
  if(h2oCalibMax > 255) {
    int h2oMaxRemain = h2oCalibMax % 255;
  }
  if(foodCalibMin > 255) {
    int foodMinRemain = foodCalibMin % 255;
  }
  if(foodCalibMax > 255) {
    int foodMaxRemain = foodCalibMax % 255;
  }
  ...
  if(h2oCalibMax < 256) {
    EEPROM.write(0, h2oMaxRemain);
    delay(5);
  }
  else if(h2oCalibMax < 511) {
    EEPROM.write(0, 255);
    delay(5);
    EEPROM.write(1, h2oMaxRemain);
    delay(5);
  }
    ...
    EEPROM.write(3, 255);
    delay(5);
    EEPROM.write(4, h2oMaxRemain);
    delay(5);
  }
  // Store minimum food analog read value
  if(foodCalibMin < 256) {
    EEPROM.write(0, foodMinRemain);
    delay(5);
  }
  else if(foodCalibMin < 511) {
    EEPROM.write(0, 255);
    delay(5);
    EEPROM.write(1, foodMinRemain);
    delay(5);
  }
    ...
    EEPROM.write(3, 255);
    delay(5);
    EEPROM.write(4, foodMinRemain);
    delay(5);
  }
  // Store maximum food analog read value
  if(foodCalibMin < 256) {
    EEPROM.write(0, foodMaxRemain);
    delay(5);
  }
  else if(h2oCalibMin < 511) {
    EEPROM.write(0, 255);
    delay(5);
    EEPROM.write(1, foodMaxRemain);
    delay(5);
  }
  else if(h2oCalibMin < 766) {
    EEPROM.write(0, 255);
    ...
    EEPROM.write(3, 255);
    delay(5);
    EEPROM.write(4, foodMaxRemain);
    delay(5);
  }
}

void retrieveAnalogMinMax() {
  byte h2oMinA = EEPROM.read(0);
  delay(5);
  byte h2oMinB = EEPROM.read(1);
  delay(5);
  byte h2oMinC = EEPROM.read(2);
  delay(5);
  byte h2oMinD = EEPROM.read(3);
  delay(5);
  byte h2oMinE = EEPROM.read(4);
  delay(5);
  byte h2oMaxA = EEPROM.read(4);
  delay(5);
  byte h2oMaxB = EEPROM.read(5);
  delay(5);
  byte h2oMaxC = EEPROM.read(6);
  delay(5);
  byte h2oMaxD = EEPROM.read(7);
  delay(5);
  byte h2oMaxE = EEPROM.read(9);
  delay(5);
  byte foodMinA = EEPROM.read(8);
  delay(5);
  byte foodMinB = EEPROM.read(9);
  delay(5);
  byte foodMinC = EEPROM.read(10);
  delay(5);
  byte foodMinD = EEPROM.read(11);
  delay(5);
  byte foodMinE = EEPROM.read();
  delay(5);
  byte foodMaxA = EEPROM.read(12);
  delay(5);
  byte foodMaxB = EEPROM.read(13);
  delay(5);
  byte foodMaxC = EEPROM.read(14);
  delay(5);
  byte foodMaxD = EEPROM.read(15);
  delay(5);
  byte foodMaxE = EEPROM.read();
  delay(5);
  minH2OVal = h2oMinA + h2oMinB + h2oMinC + h2oMinD;
  maxH2OVal = h2oMaxA + h2oMaxB + h2oMaxC + h2oMaxD;
  minFoodVal = foodMinA + foodMinB + foodMinC + foodMinD;
  minFoodVal = foodMaxA + foodMaxB + foodMaxC + foodMaxD;
}
...
void setup() {
  ...
  if(EEPROM.read(4) == 0 || EEPROM.read(8) == 0) {
