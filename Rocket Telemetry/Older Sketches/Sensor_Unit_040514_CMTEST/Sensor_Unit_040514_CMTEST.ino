...
void zeroAltitude() {
  ...
  long alt1 = baro.getHeightCentiMeters();
  delay(100);
  long alt2 = baro.getHeightCentiMeters();
  delay(100);
  long alt3 = baro.getHeightCentiMeters();
  delay(100);
  long alt4 = baro.getHeightCentiMeters();
  delay(100);
  long alt5 = baro.getHeightCentiMeters();
  delay(100);
  long alt6 = baro.getHeightCentiMeters();
  delay(100);
  long alt7 = baro.getHeightCentiMeters();
  delay(100);
  long alt8 = baro.getHeightCentiMeters();
  delay(100);
  long alt9 = baro.getHeightCentiMeters();
  delay(100);
  long alt10 = baro.getHeightCentiMeters();
  delay(100);
  long altTot = alt1 + alt2 + alt3 + alt4 + alt5 + alt6 + alt7 + alt8 + alt9 + alt10;
  delay(100);
