...
void readCompass() {
  ...
  compassString = compX + "," + compY + "," + compZ;
}
...
void gpsdump(TinyGPS &gps) {
  ...
  if(syncRequired == true) {
    ...
    gpsDataString = "$";
    gpsDataString += gpsDate;
    gpsDataString += ",";
    gpsDataString += gpsTime;
    gpsDataString += "$";
    gpsDataString += String(gpsLat);
    gpsDataString += ",";
    gpsDataString += String(gpsLon);
    gpsDataString += "$";
    gpsDataString += String(gpsAltitudeFt);
    gpsDataString += "$";
    gpsDataString += String(gpsCourse);
    gpsDataString += "$";
    gpsDataString += String(gpsSpeedMPH);
    if(landDetect == true) {
      gpsDataString += "$";
      gpsDataString += String(landDistanceFt);
    }
  }
}
