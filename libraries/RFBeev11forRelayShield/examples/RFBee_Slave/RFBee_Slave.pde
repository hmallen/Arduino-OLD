...
void myExecuteCmdFunction(byte *cmdRawData){
  byte relayPin[12] = {IO_PC_4,IO_PC_5,IO_PD_6,IO_PD_5,
  										 IO_PC_0,IO_PC_1,IO_PC_2,IO_PC_3,
  										 IO_PD_4,IO_PB_1,IO_PB_0,IO_PD_7};//pins on RFBee
  ...
  byte relayId;
  if(cmdRawData[0]>= 'A'){
  	relayId = cmdRawData[0] - 'A' + 10;
  }
  else{
  	relayId = cmdRawData[0] - '0';
	}
