...
unsigned long aggInterval = 600000;
...
void loop() {
  ...
  if (lapTimer >= aggInterval) {
    ...
    int nextWrite = (interval - intervalTimer) / 1000;
...
void sdWriteData() {
  File dataFile = SD.open("NEWESTerDATA.TXT", FILE_WRITE);  // Open data file, with full privileges, for writing
