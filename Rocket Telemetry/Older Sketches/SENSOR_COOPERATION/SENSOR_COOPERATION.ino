...
void setup()
{
  ...
  Serial.println(F("Warming up motion sensor..."));
  delay(5000);
...
void loop()
{
  ...
  {
    Serial.println(F("Failed to read from one or more sensors"));
  }
  ...
  // Altimeter
  /*Serial.println(F("Altitimeter"));
   Serial.print(F("Height(cm): "));
   Serial.println((float)(alt));
   Serial.print(F("Height(ft): "));
