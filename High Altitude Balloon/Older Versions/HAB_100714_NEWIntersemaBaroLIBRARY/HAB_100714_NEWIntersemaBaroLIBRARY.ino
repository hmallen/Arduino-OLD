...
Arduino module to be used on a high-altitude balloon flight as a
 ...
 To Do:
 - Take init and fin alt of x consecutive reads and calc ascent rate
...
#define gmtTimezoneOffset 5  // Offset in hours of current timezone from 
...
void gpsdump(TinyGPS &gps) {
  ...
  if(gpsLock == true) {
    ...
    // Time String
    byte hourCorrected = hour - gmtTimezoneOffset;
