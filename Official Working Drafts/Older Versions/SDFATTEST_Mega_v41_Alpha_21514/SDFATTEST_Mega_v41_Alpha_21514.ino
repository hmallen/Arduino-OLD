/*
 ...
 analog sensor calibration upon startup
 ...
 - Added analog sensor calibration function with EEPROM storage/retrieval capability
 - Added toggle switch to trigger debug mode on startup
 -- Debug sets EEPROM #255 to 0 to trigger automatic analog sensor calibration
