...
void setup() {
  ...
  String headerString = "Accel_X,Accel_Y,Accel_Z,Comp_X,Comp_Y,Comp_Z,Gyro_X,Gyro_Y,Gyro_Z"; // String to identify written values
...
*/
  ...
  delay(1000); // Run again after delay (Set high, but 1000 for debugging)
