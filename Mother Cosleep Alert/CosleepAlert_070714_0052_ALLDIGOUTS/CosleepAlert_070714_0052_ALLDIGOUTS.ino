...
const int buzzPin1 = 11;
const int buzzPin2 = 10;
const int buzzPin3 = 9;
const int buzzPin4 = 8;

int buzzPin = buzzPin4;
...
#ifdef debugMode
  buttonReadPrev = digitalRead(buttonPin);
  selectReadPrev = digitalRead(selectPin);
#endif
}
...
void tiltAlert() {
  ...
  delay(1500);  // Delay to allow repositioning before retriggering alert
  digitalWrite(tiltLED, LOW);
}
